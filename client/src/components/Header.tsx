...
import { Bell, Plus, Home, Users, UserCheck, DollarSign, FileText, Settings, Menu, LogOut, User, Receipt, Calculator, Shield, Cigarette, GraduationCap } from "lucide-react";
...
export default function Header({ user, onLogout }: HeaderProps) {
  ...
  const navItems = [
    ...
    { path: "/graduates", label: "الخريجين", icon: GraduationCap },
